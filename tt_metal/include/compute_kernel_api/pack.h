 ...
 * buffer, but relative to the position that might have ben previously updated
 ...
 * synchronized in the kernels. To ensure this synchronization, tile packing is implementeed as a separate
 * API call.
 *
 * Return value: None
 *
