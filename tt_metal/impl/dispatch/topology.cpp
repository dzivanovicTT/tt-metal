...
std::pair<tt::tt_fabric::FabricEriscDatamoverType, tt::tt_fabric::FabricEriscDatamoverAxis> get_fabric_edm_type(
    ...
    if (topology != tt_fabric::Topology::Ring) {
        return {tt::tt_fabric::FabricEriscDatamoverType::Default, tt::tt_fabric::FabricEriscDatamoverAxis::Row};
    }
    ...
    auto fabric_edm_axis = tt::tt_fabric::FabricEriscDatamoverAxis::Row;
    ...
    if (wrap_around_mesh) {
        ...
        if (is_dateline_edm_along_column) {
            fabric_edm_type = tt::tt_fabric::FabricEriscDatamoverType::Dateline;
            fabric_edm_axis = tt::tt_fabric::FabricEriscDatamoverAxis::Col;
        }
        // Row dateline
