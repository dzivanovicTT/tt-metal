...
flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<::distributed::flatbuffer::SocketConnection>>>
to_flatbuffer(flatbuffers::FlatBufferBuilder& builder, const std::vector<SocketConnection>& socket_connections) {
...
std::vector<SocketConnection> from_flatbuffer(
    const flatbuffers::Vector<flatbuffers::Offset<::distributed::flatbuffer::SocketConnection>>*
        fb_socket_connections) {
...
std::vector<std::byte> serialize_to_bytes(const SocketPeerDescriptor& socket_peer_desc) {
    ...
    byte_vector.reserve(builder.GetSize());
    std::transform(
...
SocketPeerDescriptor deserialize_from_bytes(const std::vector<std::byte>& data) {
    ...
    socket_peer_desc.address = socket_peer_desc_fb->address();
