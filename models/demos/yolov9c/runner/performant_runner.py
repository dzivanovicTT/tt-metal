...
class YOLOv9PerformantRunner:
    def __init__(
        ...
        self.capture_yolov9_trace_2cqs()

    def capture_yolov9_trace_2cqs(self):
    ...
    def execute_yolov9_trace_2cqs_inference(self, tt_inputs_host=None):
        print(f"exec trace cqs - tt_inputs_host: {None if tt_inputs_host is None else tt_inputs_host.shape}")
    ...
    def validate(self, input_tensor, result_output_tensor):
    ...
    def run(self, torch_input_tensor):
        ...
        return self.execute_yolov9_trace_2cqs_inference(tt_inputs_host=tt_inputs_host)
