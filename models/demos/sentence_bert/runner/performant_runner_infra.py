...
class SentenceBERTPerformanceRunnerInfra:
    def __init__(
        ...
        self.torch_output = self.torch_model(
            ...
            attention_mask_2=self.attention_mask,
    ...
    def setup_l1_sharded_input(
        ...
        ttnn_attention_mask_2 = ttnn.from_torch(attention_mask, dtype=ttnn.bfloat16)
        return (
            input_ids,
            input_mem_config,
            ttnn_token_type_ids,
    ...
    def run(self):
        self.ttnn_output_tensor = self.ttnn_sentencebert_model(
            ...
            attention_mask_2=self.ttnn_att_mask_2,
