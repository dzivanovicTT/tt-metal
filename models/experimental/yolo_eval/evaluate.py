...
def evaluation(
    ...
    for batch in data_set:
        ...
        elif model_name in ["YOLOv8s", "YOLOv8s_World", "YOLOv8x", "YOLOv9c"]:
            ttnn_im = im.clone()
        else:
        ...
        if model_name not in ["YOLOv4", "YOLOv9c", "YOLOv10", "YOLOv8s_World", "YOLOv8s", "YOLOv8x"]:
    ...
    for ttnn_im, im, im0s in preprocessed_images:
        if model_type == "torch_model":
            ...
            elif model_name in ["YOLOv10", "YOLOv8s", "YOLOv8x"]:
