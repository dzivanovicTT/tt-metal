...
#include "flash_mla_decode_pybind.hpp"

#include <pybind11/pybind11.h>
#include <pybind11/stl.h>

#include "flash_mla_decode.hpp"
#include "ttnn-pybind/decorators.hpp"

namespace ttnn::operations::transformer {

void py_bind_flash_mla_decode(py::module& module) {
    auto doc =
        R"doc(
    ...
    using OperationType = decltype(ttnn::transformer::flash_mla_decode);
    ttnn::bind_registered_operation(
        module,
        ttnn::transformer::flash_mla_decode,
        doc,
    ...
    using PagedOperationType = decltype(ttnn::transformer::paged_flash_mla_decode);
    ttnn::bind_registered_operation(
        module,
